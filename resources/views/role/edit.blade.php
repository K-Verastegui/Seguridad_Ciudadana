...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Edicion de Rol <span class="nav-icon fas fa-user-tag"></span></h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
        <div class="row">
            <div class="col-md-12">
                <form action="{{route('role.update',$role->id)}}" method="post">
                    ...
                    <div class="form-group">
                        <textarea name="description" cols="30" rows="2" placeholder="Description" class="form-control">{{old('description',$role->description)}}</textarea>
